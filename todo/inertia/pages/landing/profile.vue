<template>
    <!-- Header -->
    <div class="h-[200px] bg-pink-400 rounded-br-3xl rounded-bl-3xl flex items-center justify-center">
        <div class="flex flex-col gap-5 items-center text-white">
