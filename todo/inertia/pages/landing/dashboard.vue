<template>
  <div class=" max-h-screen">
    <!-- Container pusat dengan max width -->
        ...
        <div class="overflow-x-auto">
          <ul class="flex gap-7 min-w-full">
            <li
              ...
              :key="todo.id"
              :class="['rounded-lg h-[175px] relative p-5 shrink-0', getRandomBg(index)]"
            >
              <div class="w-[200px]">
      ...
      <div class="w-full overflow-x-auto flex items-center justify-center p-5">
        <div class="flex items-center gap-2 mt-4">
          <span
            ...
            :class="[
              'px-3 py-1 font-medium bg-slate-50/60 md:flex md:items-center md:justify-center cursor-pointer',
              date === selectedDate
                ? 'text-3xl w-[50px] h-[50px] rounded-xl'
...
const dates = [
  today.minus({ days: 3 }).day,
  today.minus({ days: 2 }).day,
